...
python ml_model.py python manage.py runserver

http://127.0.0.1:8000/api/predict-crowd { "hour": 14, "day_of_week": 5, "weather": "Sunny" }<br>
=======Answer======== "status": "success", "predicted_crowd_count": 563

http://127.0.0.1:8000/api/predict-wait-time { "ride_id": 3, "current_crowd": 2200, "day_of_week": 6 }<br>
=======Answer======== { "status": "success", "ride_id": 3, "predicted_wait_time_minutes": 16 }

Edited README.md Viewed README.md:28-45
